...
class PostController extends Controller
{
    ...
    {
        // create a variable and store all the blog posts in in
    ...
    {   
        // find the post in the database and save it as a varibale
            $post = Post::find($id);
    ...
    public function edit($id)
    {
        ...
        // return the view and pass in the var     
            return view('manage.posts.edit')->withPost($post)->withCategories($cats)->withTags($tags2);
    }       
