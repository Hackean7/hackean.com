...
<div class="flex-container">
    <div class="columns m-t-10">
        <div class="column">
            <h1 class="title is-2 is-admin has-text-centered">Create New Permission</h1>
        </div>
    </div>
    <hr class="m-t-0">
        ...
        <div class="column">
            <form action="{{ route('permissions.store') }}" method="post">
                ...
                <div class="field" v-if="permissionType == 'basic'">
                    ...
                    <p class="control">
                        <input type="text" class="input is-primary" placeholder="Name" name="display_name" id="display_name">
                    </p>
                </div>
                ...
                <div class="field" v-if="permissionType == 'basic'">
                    ...
                    <p class="control">
                        <input type="text" class="input is-primary" name="description" id="description" placeholder="Describe what this permission does">
                    </p>
                </div>

                <div class="field" v-if="permissionType == 'crud'">
                    <label for="resource" class="label m-t-20">Resource</label>
                    <p class="control">
                        <input type="text" class="input is-primary" name="resource" id="resource" v-model="resource" placeholder="The name of the resource">
                    </p>
                </div>
